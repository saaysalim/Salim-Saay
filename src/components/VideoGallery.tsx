    ...
    <section id="video-gallery" className="py-20 px-4 bg-background min-h-screen">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="bg-card rounded-lg shadow-lg overflow-hidden mb-8">
          ...
          <div className="relative bg-gray-900 aspect-video flex items-center justify-center">
            <div className="absolute inset-0 bg-black/80 flex items-center justify-center">
              <div className="text-center text-white">
                ...
                <h3 className="text-lg mb-2">{videos[currentVideo].title}</h3>
          ...
          {/* Video Info */}
          <div className="p-6">
            <h3 className="text-xl mb-2">{videos[currentVideo].title}</h3>
            <p className="text-muted-foreground mb-4">{videos[currentVideo].description}</p>
